...
variable "vpc_tags" {
  ...
  type        = map(string)
  default     = { "Name" = "vpc", "created-by" = "terraform" }
}
...
variable "asg_sg_tags" {
  ...
  type        = map(string)
  default     = { "Name" = "asg-sg", "created-by" = "terraform" }
}
...
variable "asg_iam_role_tags" {
  ...
  type        = map(string)
  default     = { "Name" = "asg-iam-role", "created-by" = "terraform" }
}
...
variable "asg_instance_tags" {
  ...
  type        = map(string)
  default     = { "Name" = "asg-instance", "created-by" = "terraform" }
}

variable "asg_volume_tags" {
  description = "Auto scaling group volume tags"
  type        = map(string)
  default     = { "Name" = "asg-volume", "created-by" = "terraform" }
}

variable "asg_tags" {
  description = "Auto scaling group tags"
  type        = map(string)
  default     = { "Name" = "asg", "created-by" = "terraform" }
}
...
variable "alb_sg_tags" {
  ...
  type        = map(string)
  default     = { "Name" = "alb-sg", "created-by" = "terraform" }
}
...
variable "alb_tags" {
  ...
  type        = map(string)
  default     = { "Name" = "alb", "created-by" = "terraform" }
}
...
variable "rds_sg_tags" {
  ...
  type        = map(string)
  default     = { "Name" = "rds-sg", "created-by" = "terraform" }
}
...
variable "rds_tags" {
  ...
  type        = map(string)
  default     = { "Name" = "rds", "created-by" = "terraform" }
}
